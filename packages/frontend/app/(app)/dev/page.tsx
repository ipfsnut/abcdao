            ...
            {membership.isMember ? (
              ...
              >
                ...
                <div className="flex items-center justify-between mt-2">
                  <span className="text-indigo-500 font-mono text-xs">Members Only</span>
                  <span className="text-indigo-400">→</span>
                </div>
              </a>
            ) : (
              <div className="bg-gray-950/20 border border-gray-900/50 rounded-lg p-4 opacity-60">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="text-gray-400 font-mono text-sm font-semibold">Discord</h3>
                </div>
                <p className="text-gray-500 font-mono text-xs">Developer community chat</p>
                <div className="flex items-center justify-between mt-2">
                  <span className="text-gray-500 font-mono text-xs">Membership Required</span>
