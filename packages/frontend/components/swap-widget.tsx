        ...
        <div className="bg-black/60 border border-green-900/30 rounded-lg p-4 min-h-[200px] flex flex-col items-center justify-center">
          <div className="w-full max-w-md text-center space-y-4">
            ...
            <button
              onClick={handleSwap}
              disabled={isLoading}
              className="w-full bg-green-900/50 hover:bg-green-800/60 disabled:bg-green-950/30 text-green-400 font-mono px-6 py-4 rounded-lg border border-green-700/50 transition-all duration-300 matrix-button text-base font-semibold disabled:opacity-50"
            >
              {isLoading ? '⏳ Opening...' : '💱 Swap for $ABC'}
            </button>
            ...
            <div className="flex gap-2">
              <button
                ...
                disabled={isLoading}
                className="flex-1 bg-blue-900/50 hover:bg-blue-800/60 disabled:bg-blue-950/30 text-blue-300 font-mono px-4 py-2 rounded-lg border border-blue-700/50 transition-all duration-300 matrix-button text-sm disabled:opacity-50"
              >
                👁️ View Token
              </button>
