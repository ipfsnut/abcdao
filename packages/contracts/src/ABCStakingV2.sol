...
contract ABCStakingV2 is ReentrancyGuard, Ownable, Pausable {
    // TODO: Update this with the actual ABC token address when deploying
    IERC20 public constant ABC_TOKEN = IERC20(0xf87F3ebbF8CaCF321C2a4027bb66Df639a6f4B07);
    ...
    function isEligibleForRewards(address _user) external view returns (bool) {
        return stakes[_user].amount >= 100 * 1e18; // 100 ABC minimum for testing
    }
