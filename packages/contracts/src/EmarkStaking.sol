...
contract EmarkStaking is ReentrancyGuard, Ownable, Pausable {
    ...
    uint256 public constant COOLDOWN_PERIOD = 1 days; // Shorter for testing
    ...
    function unstake(uint256 _amount) external nonReentrant whenNotPaused updateReward(msg.sender) {
        ...
        // Transfer EMARK tokens back to user
        EMARK_TOKEN.transfer(msg.sender, _amount);
